...
Control the user's Spotify account via the DASHENG Spotify toolset (7 tools). Setup guide: https://dasheng-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `dasheng auth spotify` again.
