...
| File operations | Bash commands | DASHENG file tools (write_file, read_file) |
...
Reference files can be overwritten directly (they're unchanged from upstream). SKILL.md must be manually merged since it contains DASHENG-specific adaptations.
