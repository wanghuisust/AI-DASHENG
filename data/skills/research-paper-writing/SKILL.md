...
## DASHENG Agent Integration

This skill is designed for the DASHENG agent. It uses DASHENG tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other DASHENG skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.dasheng/plans/` | `skill_view("plan")` |
