...
```bash
python3 -m pyfiglet "DASHENG" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=DASHENG&font=Slant" | boxes -d stone
```
