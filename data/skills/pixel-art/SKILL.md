...
```python
import sys
sys.path.insert(0, "/home/teknium/.dasheng/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.dasheng/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — DASHENG installs package this)
