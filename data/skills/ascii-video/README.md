...
Built for [DASHENG Agent](https://github.com/NousResearch/dasheng-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/dasheng-agent/skills/creative/ascii-video`](https://github.com/NousResearch/dasheng-agent/tree/main/skills/creative/ascii-video) via PR.
